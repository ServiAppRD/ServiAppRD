      ...
      switch (view) {
                ...
                <div className="fixed inset-0 md:relative md:inset-auto md:z-0 z-[1000] bg-gray-50 flex flex-col animate-fade-in overflow-y-auto md:overflow-visible h-full md:h-auto">
                   <div className="bg-white p-4 shadow-sm sticky top-0 z-10 flex items-center justify-between pt-12 md:pt-4">
                      <div className="flex items-center gap-3">
                         <Button variant="ghost" size="icon" onClick={() => setView('dashboard')} className="md:hidden"><ArrowLeft className="h-6 w-6" /></Button>
                ...
                <div className="fixed inset-0 md:relative md:inset-auto md:z-0 z-[1000] bg-white flex flex-col animate-fade-in h-full md:h-auto md:rounded-3xl md:shadow-sm md:border md:overflow-hidden">
                   <div className="relative bg-[#0239c7] text-white rounded-b-[40px] overflow-hidden pb-8 shrink-0">
                       ...
                       <div className="relative z-10 px-4 pt-12 md:pt-4 flex items-center justify-between h-16">
                          <button onClick={() => setView('dashboard')} className="w-10 h-10 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center hover:bg-white/20 transition-colors md:hidden">
            ...
            return (
                <div className="fixed inset-0 md:relative md:inset-auto md:z-0 z-[1000] bg-gray-100 flex flex-col animate-fade-in overflow-y-auto h-full md:h-auto md:bg-white">
                   <div className="bg-white p-4 shadow-sm sticky top-0 z-10 flex items-center pt-6 md:pt-4">
                      <Button variant="ghost" size="icon" onClick={() => setView('dashboard')} className="-ml-2 mr-2 md:hidden">
          ...
          case 'notifications':
            return (
                <div className="fixed inset-0 md:relative md:inset-auto md:z-0 z-[1000] bg-gray-50 flex flex-col animate-fade-in overflow-y-auto h-full md:h-auto">
                   <div className="bg-white p-4 shadow-sm sticky top-0 z-10 flex items-center justify-between pt-12 md:pt-4">
                      <div className="flex items-center gap-3">
                         <Button variant="ghost" size="icon" onClick={handleBackToDashboard} className="md:hidden"><ArrowLeft className="h-6 w-6" /></Button>
            ...
            return (
                <div className="fixed inset-0 md:relative md:inset-auto md:z-0 z-[1000] bg-white flex flex-col animate-fade-in overflow-y-auto h-full md:h-auto">
                   <div className="p-4 flex items-center gap-3 pt-12 md:pt-4">
                       <Button variant="ghost" size="icon" onClick={() => setView('account-settings')} className="md:hidden"><ArrowLeft className="h-6 w-6" /></Button>
          ...
          case 'account-settings':
            return (
              <div className="fixed inset-0 md:relative md:inset-auto md:z-0 z-[1000] bg-gray-50 flex flex-col animate-fade-in overflow-y-auto h-full md:h-auto">
                 <div className="bg-white p-4 shadow-sm sticky top-0 z-10 flex items-center justify-between pt-12 md:pt-4">
                    <div className="flex items-center gap-3"><Button variant="ghost" size="icon" onClick={handleBackToDashboard} className="md:hidden"><ArrowLeft className="h-6 w-6" /></Button><h1 className="text-lg font-bold">Administrar Cuenta</h1></div>
                 </div>
                 <div className="p-5 space-y-6 pb-24 md:pb-6">
                    <div className="space-y-2">
            ...
            return (
                <div className="fixed inset-0 md:relative md:inset-auto md:z-0 z-[1000] bg-gray-50 flex flex-col animate-fade-in overflow-y-auto h-full md:h-auto">
                   <div className="bg-white p-4 shadow-sm sticky top-0 z-10 space-y-4 pt-12 md:pt-4">
                      <div className="flex items-center gap-3"><Button variant="ghost" size="icon" onClick={()=>setView('dashboard')} className="md:hidden"><ArrowLeft className="h-6 w-6" /></Button><h1 className="text-lg font-bold">Métricas de Rendimiento</h1></div>
          ...
          case 'reputation':
            return (
              <div className="fixed inset-0 md:relative md:inset-auto md:z-0 z-[1000] bg-gray-50 flex flex-col animate-fade-in overflow-y-auto h-full md:h-auto">
                <div className="bg-white p-4 shadow-sm sticky top-0 z-10 flex items-center justify-between pt-12 md:pt-4">
                   <div className="flex items-center gap-3"><Button variant="ghost" size="icon" onClick={()=>setView('dashboard')} className="md:hidden"><ArrowLeft className="h-6 w-6" /></Button><h1 className="text-lg font-bold">Reputación</h1></div>
                </div>
                <div className="p-5 space-y-6 pb-24 md:pb-6">
            ...
            return (
              <div className="fixed inset-0 md:relative md:inset-auto md:z-0 z-[1000] bg-white flex flex-col animate-fade-in overflow-y-auto h-full md:h-auto">
                <div className="flex items-center gap-4 p-4 sticky top-0 bg-white z-10 pt-12 md:pt-4 border-b md:border-none shadow-sm md:shadow-none">
                    <Button variant="ghost" size="icon" onClick={() => setView('dashboard')} className="-ml-2 md:hidden"><ArrowLeft className="h-6 w-6" /></Button>
                    <h1 className="text-lg font-bold">Mis datos personales</h1>
                </div>
