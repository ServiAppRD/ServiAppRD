...
import { Search, PlusCircle, User, Crown, LayoutDashboard, Briefcase, BarChart3, Settings, LogOut, ChevronDown } from "lucide-react";
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-64 p-2 rounded-2xl shadow-xl border-gray-100 bg-white mr-4" align="end" forceMount>
                ...
                <div className="space-y-1">
                    ...
                    <DropdownMenuItem onClick={() => navigate('/profile-settings')} className="rounded-xl px-3 py-2.5 cursor-pointer focus:bg-orange-50 focus:text-[#F97316]">
